...
# Show password input if not yet authenticated
if not st.session_state.authenticated:
    ...
    if password:
        if password == correct_password:
            ...
            st.experimental_rerun()  # Should work now outside widget context
        else:
...
inventory = {
    ...
    "Work Protection Gear": [
        ...
        {"Item": "Safety Vest", "Image": "https://i.imgur.com/yCdgH0u.jpeg", "Price": 3.73, "Sizes": ["L", "XL", "2XL", "3XL"]}
    ],
  "Job Fair Souvenirs": [
        ...
        {"Item": "Roll Sticky Note", "Image": "https://i.imgur.com/4esEB2G.jpeg", "Price": 0.65, "Sizes": []},
        {"Item": "Small Notebook", "Image": "https://i.imgur.com/rNLEXq1.jpeg", "Price": 0.35, "Sizes": []}
    ]
}
# Contact Info
